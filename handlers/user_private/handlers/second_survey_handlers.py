...
@user_private_router.callback_query(MessageState.stage_2, F.data.startswith("Pennet_table_results"))
...
@user_private_router.callback_query(MessageState.stage_1, F.data.startswith("type_of_color_eye_second"))
...
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith('blue_second'))
...
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith('kari_second'))
async def third_quest_eye(callback: types.CallbackQuery, state: FSMContext):
...
@user_private_router.callback_query(MessageState.st_quest_3, F.data.startswith('final_yes_kari_second'))
...
@user_private_router.callback_query(MessageState.st_quest_3, F.data.startswith('final_no_kari_second'))
...
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith('green/light_brown_second'))
async def st_quest_3_green_light_brown(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
...
@user_private_router.callback_query(MessageState.stage_1, F.data.startswith('type_of_blood_second'))
...
## Перша група крові
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith("first_blood_second"))
async def first_quest(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
...
## Друга група крові
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith("second_blood_second"))
...
@user_private_router.callback_query(MessageState.st_quest_3, F.data.startswith('final_yes_blood_second_second'))
...
@user_private_router.callback_query(MessageState.st_quest_3, F.data.startswith('final_no_blood_second_second'))
async def st_quest_3_no(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
...
## Терться група крові
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith("third_blood_second"))
async def third_quest_blood(callback: types.CallbackQuery, state: FSMContext):
...
@user_private_router.callback_query(MessageState.st_quest_3, F.data.startswith('final_yes_blood_second'))
async def st_quest_3(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
...
@user_private_router.callback_query(MessageState.st_quest_3, F.data.startswith('final_no_blood_second'))
async def st_quest_3_no(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
...
@user_private_router.callback_query(MessageState.st_quest_2, F.data.startswith("fourth_blood_second"))
async def third_quest_blood(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
